...
for k in range(1):
    ...
    file_lists = sorted(
        glob.glob(f'/Users/danawls/Desktop/*Important*/traffic-deep-learning-research/test_data/7/*.csv'))

    file_list = file_lists[-3:]
    pred_file = f'/Users/danawls/Desktop/*Important*/traffic-deep-learning-research/test_data/7/6000VDS03500.csv'
...
# df.to_csv('/Users/danawls/Desktop/*Important*/traffic-deep-learning-research/table-figure/table/deep-compare/newell.csv', index=False)