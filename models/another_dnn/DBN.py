...
def train_dbn_model(data):
    ...
    # DBN 모델 학습
    dbn_model = SupervisedDBNRegression(hidden_layers_structure=[100, 100],
    ...
    # 예측 수행
    y_pred_scaled = dbn_model.predict(X_test)
...
plt.title('DBN Model: Actual vs Predicted Traffic(Q)')
plt.legend()
plt.grid()
plt.show()