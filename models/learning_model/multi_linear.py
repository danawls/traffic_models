...
# 다중 회귀 모델 학습 및 예측 함수
def train_multiple_regression_model(data):
    # 입력 데이터와 타겟 데이터 정의
...
# 다중 회귀 모델 학습 및 예측
y_test, y_pred = train_multiple_regression_model(data)
...
plt.title('Multiple Regression Model: Actual vs Predicted Traffic(Q)')
plt.legend()
plt.grid()
plt.show()