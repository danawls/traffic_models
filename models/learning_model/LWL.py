...
file_paths = glob.glob(f'/Users/danawls/Desktop/*Important*/traffic-deep-learning-research/test_data/7/6000VDS03500.csv')
...
if file_paths:  # 파일이 존재하는지 확인
    ...
    #df.to_csv('/Users/danawls/Desktop/*Important*/traffic-deep-learning-research/table-figure/table/deep-compare/lwl.csv', index=False)
